      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 pb-8">
          ...
          <div className="flex flex-col items-center -mt-16 sm:-mt-20">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-8 mt-6 w-full max-w-md">
              ...
              <div className="text-center">
                <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                  {totalWishListQuantity > 0 ? (
                    <Link href={`/user/wishlist`}>{totalWishListQuantity}</Link>
                  ) : (
                    "0"
                  )}
                </p>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-1 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {totalQuantity > 0 ? (
              <Link href={"/user/cart"} className="text-orange-400">
                Enter to show your cart
              </Link>
            ) : (
              "No orders yet"
            )}
